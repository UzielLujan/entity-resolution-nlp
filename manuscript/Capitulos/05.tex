...
La proyección UMAP de los embeddings del Bi-Encoder canónico muestra grupos compactos de registros pertenecientes a una misma entidad, con registros procedentes de distintas fuentes dentro de las mismas vecindades. Esta visualización es coherente con las métricas de recuperación y separación, pero es diagnóstica: no sustituye una medida cuantitativa ni permite inferir por sí sola la cobertura de coincidencias no observadas.
